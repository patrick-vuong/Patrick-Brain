...
| **Runtime** | Node.js (LTS) | Required for Next.js, SSR, build tools (Vite, Webpack), and most React meta-frameworks. Use the current LTS version for stability and security patches. |
